...
public class CrmcustomerdetailsServiceImpl implements CrmcustomerdetailsService {
    ...
    public List<CrmcustomerdetailsVop> selectCrmcustomerdetailsVopList(Integer id, HttpServletRequest request, HttpServletResponse response) {
        ...
        for (CrmcustomerdetailsVop crmcustomerdetailsVop : crmcustomerdetailsVops) {
            ...
            crmcustomerdetailsVop.setZsT(Timestamp.valueOf(crmcustomerdetailsVop.getCreateTime()));
    ...
    @Override
    public List<CrmcustomerdetailsVop> selectcrmcustomerdetailsVopListByUser(Integer userId) {
        List<CrmcustomerdetailsVop> crmcustomerdetailsVops = null;
        Crmcustomerdetails crmcustomerdetails = new Crmcustomerdetails();
        crmcustomerdetails.setFollowupId(userId);
        try {
            crmcustomerdetailsVops = crmcustomerdetailsDao.selectcrmcustomerdetailsVopListByUser(crmcustomerdetails);
        } catch (Exception e) {

        }
        if (null != crmcustomerdetailsVops && crmcustomerdetailsVops.size() > 0) {
            for (CrmcustomerdetailsVop crmcustomerdetailsVop : crmcustomerdetailsVops) {
                crmcustomerdetailsVop.setPath(crmcustomerdetailsVop.getChatrecord().split("@"));
                crmcustomerdetailsVop.setZsT(Timestamp.valueOf(crmcustomerdetailsVop.getCreateTime()));
                java.sql.Date date = new java.sql.Date(crmcustomerdetailsVop.getZsT().getTime());
    ...
    @Override
    public List<Crmcustomerdetails> selectcrmcustomerByUserCount(CrmcustomerdetailsVop crmcustomerdetailsVop) {
        List<Crmcustomerdetails> crmcustomerdetails=null;
        try {
            crmcustomerdetails=crmcustomerdetailsDao.selectcrmcustomerByUserCount(crmcustomerdetailsVop);
        } catch (Exception e) {

        }
        return crmcustomerdetails;
    }
}
