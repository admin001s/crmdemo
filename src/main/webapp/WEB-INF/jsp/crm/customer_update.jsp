                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="customersId" placeholder="输入客户编号" value="${customer.customersId}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="customersName" placeholder="输入客户名称"
                                                   value="${customer.customersName}"       class=" col-xs-10 col-sm-5" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div>
                                                <label class="line-height-1 blue">
                                                    <input name="customersSex" id="form-field-1-1-1" value="0"
                                                           type="radio" class="ace" <c:if test="${customer.customersSex==0}">checked</c:if>/>
                                                    <span class="lbl"> 男</span>
                                                </label>
                                                <label class="line-height-1 blue">
                                                    <input name="customersSex" value="1" type="radio" class="ace" <c:if test="${customer.customersSex==1}">checked</c:if>/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="input-group">
                                                ...
                                                <input type="tel" id="telephone" name="phone" value="${customer.telephone}"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div>
                                                <label class="line-height-1 blue">
                                                    <input name="isVip" id="isVIP" value="0" type="radio" class="ace" <c:if test="${customer.isVip==0}">checked</c:if>/>
                                                    <span class="lbl"> 是</span>
                                                </label>
                                                <label class="line-height-1 blue">
                                                    <input name="isVip" value="1" type="radio" class="ace" <c:if test="${customer.isVip==1}">checked</c:if>/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-9">
                                            <div class="clearfix">
                                                <input  type="email" name="email" id="email" class="col-xs-12 col-sm-6" value="${customer.email}"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="industryCategory" placeholder="输入行业大类"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.industryCategory}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="industrySubclass" placeholder="输入行业子类"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.industrySubclass}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="customerSource" placeholder="输入客户来源"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.customerSource}"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 col-sm-3 control-label no-padding-right"
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="customerUrlSource" placeholder="输入客户网址来源"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.customerUrlSource}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="companywebsite" placeholder="输入公司名称"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.companywebsite}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="companyAddress" placeholder="输入公司地址"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.companyAddress}"/>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="pos-rel">
                                                <textarea class="form-control limited autosize-transition"
                                                          id="companydetails" maxlength="50">${customer.companydetails}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9 col-sm-9">
                                            <input type="text" id="mainproducts" placeholder="主要产品"
                                                   class="col-xs-10 col-sm-5" autocomplete="off" value="${customer.mainproducts}"/>
                                        </div>
                                    </div>
                                </div><!-- /.col -->
                            </div><!-- /.row -->
